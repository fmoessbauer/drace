 ...
 */
void MemoryTracker::insert_jmp_on_flush(void *drcontext, instrlist_t *ilist,
                                        instr_t *where, reg_id_t regxcx,
                                        reg_id_t regtls, instr_t *call_flush) {
  instr_t *instr;
  opnd_t opnd1, opnd2;
  ...
  opnd2 = OPND_CREATE_MEMPTR(regtls, offsetof(ShadowThreadState, no_flush));
...
void MemoryTracker::instrument_mem_full(void *drcontext, instrlist_t *ilist,
