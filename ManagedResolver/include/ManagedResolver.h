...
#pragma warning( \
    disable : 4091)   // dbghelp.h(1544): warning C4091: 'typedef ': ignored on
                      // left of '' when no variable is declared
...
class ManagedResolver {
 ...
 public:
  ...
  bool InitSymbolResolver(HANDLE hProcess, const char* mscordaccore_path,
                          CString& lastError);
  ...
  bool GetModuleFileLineInfo(void* ip, CStringA* lineInfo, uint64_t* lineNumber,
                             CStringA* modulePath);
